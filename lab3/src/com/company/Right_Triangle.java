...
public class Right_Triangle extends Figure{
    ...
    private static double xv0 = x2-x1;
    private static double yv0 = y2-y1;

    private static double xv1 = x3-x2;
    private static double yv1 = y3-y2;

    private static double xv2 = x3-x1;
    private static double yv2 = y3-y1;
    ...
    public double ploshad(){
        if ((xv0 * xv1) + (yv0 * yv1) == 0){
            return dl_r1() * dl_r3() /2 ;
        }
        else if ((xv2 * xv1) + (yv2 * yv1) == 0){
            return dl_r1() * dl_r2() /2 ;
        }
        else {
            return dl_r2() * dl_r3() /2 ;
        }
